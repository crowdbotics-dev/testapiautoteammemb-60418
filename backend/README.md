...
## Project Structure
    ...
    ├── testapiautoteammemb_60418  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_60418`
...
2. Clone this repo and `cd testapiautoteammemb_60418`
